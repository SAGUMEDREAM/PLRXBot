...
from src.maimai.schema.enum import SongType, LevelIndex
from src.maimai.schema import Song, Score, SongDifficulty, SongDifficultyUtage


def get_difficulty(
    song: Song, type: SongType, level_index: LevelIndex
) -> Union[SongDifficulty, SongDifficultyUtage, None]:
...
async def calc_star_count(score: Score) -> Optional[int]:
    """计算 DX 分数星星数量"""
